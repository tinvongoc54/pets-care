...
/// @nodoc
mixin _$SplashState {
  bool get isCountDownFinished => throw _privateConstructorUsedError;
...
abstract class $SplashStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isCountDownFinished});
}
...
class _$SplashStateCopyWithImpl<$Res, $Val extends SplashState>
  ...
  @override
  $Res call({
    Object? isCountDownFinished = null,
  }) {
    return _then(_value.copyWith(
      isCountDownFinished: null == isCountDownFinished
          ? _value.isCountDownFinished
          : isCountDownFinished // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$SplashStateImpl implements _SplashState {
  const _$SplashStateImpl({this.isCountDownFinished = false});
  ...
  @override
  String toString() {
    return 'SplashState(isCountDownFinished: $isCountDownFinished)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isCountDownFinished, isCountDownFinished) ||
                other.isCountDownFinished == isCountDownFinished));
  }

  @override
  int get hashCode => Object.hash(runtimeType, isCountDownFinished);
...
abstract class _SplashState implements SplashState {
  const factory _SplashState({final bool isCountDownFinished}) =
      _$SplashStateImpl;
